...
?>
            ...
            <form>
              <div class="col coll">
                <div class="blc-chp">
                  ...
                  <div class="on-off">
                      <input type="checkbox" class="onoff" id="masque1" <?php if ( get_field('fixer_un_objectif', $idCagnotte) ) echo ' checked="checked"'; ?>>
                ...
                <div class="blc-chp">
                   <div class="blc-check">
                      <div class="option">
                        <ul>
                           <li class="chp">
                              <input id="masque1"  type="checkbox"<?php if ( get_field('masquer_azo_ilaina', $idCagnotte) ) echo ' checked="checked"'; ?>>
 ...
 -->
		  ...
		  <a href="<?php echo get_permalink( $idCagnotte ) ?>" class="link submit" title="Enregistrer" id="submit-montant"><?php _e('Enregistrer','kotikota') ?></a>
	        </div>
