                                                        ...
                                                        <tr>
                                                            <td align="center" class="text" style="font-size: 0px; padding: 0 46px 10px; word-break: break-word;">
                                                                <div style="font-family: Arial; font-size: 16px; line-height: 24px; text-align: center; color: #000000;">
                                                                    <p>Chers KotiKoteurs 📢</p>
                                                                    <p>&nbsp;</p>
                                                                    <p>La cagnotte « <?= $nomcagnotte ?> » a bien été clôturée</p> 
                                                                    <p>&nbsp;</p>
                                                                    <p>Vous retrouverez toutes la caractéristiques de la cagnotte en <a href="<?= get_permalink( $id ) ?>" target="_blank">cliquant ici 🖱</a></p>
                                                                </div>
                                                                <br>
                                                                 <br>
                                                            </td>
