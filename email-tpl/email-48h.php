                                                        ...
                                                        <tr>
                                                            <td align="center" class="text" style="font-size: 0px; padding: 0 46px 10px; word-break: break-word;">
                                                                <div style="font-family: Arial; font-size: 16px; line-height: 24px; text-align: center; color: #000000;">
                                                                    Voilà maintenant 48 heures que vous avez créé une cagnotte sur la plateforme <a href="<?= site_url() ?>" title="">Koti Kota</a>.
                                                                    <br><br>
                                                                    Vous nous avez malheureusement pas fourni votre pièce d'identité.
                                                                    <br><br>
                                                                    Votre compte et vos cagnottes en cours vont alors être suspendus dorénavant.
                                                                    <br><br>
