                                                        ...
                                                        <tr>
                                                            <td align="center" class="text" style="font-size: 0px; padding: 0 46px 10px; word-break: break-word;">
                                                                <div style="font-family: Arial; font-size: 16px; line-height: 24px; text-align: center; color: #000000;">
                                                                    <?php _e("Voilà maintenant 48 heures que vous avez créé une cagnotte sur la plateforme","kotikota") ?> <a href="<?= site_url() ?>" title="">Koti Kota</a>.
                                                                    <br><br>
                                                                    <?php _e("Vous nous avez malheureusement pas fourni votre pièce d'identité.","kotikota") ?>
                                                                    <br><br>
                                                                    <?php _e("Votre compte et vos cagnottes en cours vont alors être suspendus dorénavant.","kotikota") ?>
                                                                    <br><br>
