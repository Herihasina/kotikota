...
<head>
        ...
        <style type="text/css">
            ...
            [owa] .mj-column-px-110 {
                width: 110px !important;
                max-width: 110px;
            }
            [owa] .mj-column-px-375 {
                width: 375px !important;
                max-width: 375px;
            }
            [owa] .mj-column-px-114 {
                width: 114px !important;
                max-width: 114px;
            }
        </style>
        ...
        <style type="text/css">
            ...
            @media only screen and (max-width: 670px) {
                .mj-column-px-600.text {
                    width: 100% !important;
                    max-width: 100%s;
                }
                .head {
                    background: none !important;
                    background-color: #59bdb1 !important;
                }
                .head > div > table {
                    background: none !important;
                    background-color: #59bdb1 !important;
                }
                .head > div > table > tbody > tr > td {
    ...
    <![endif]-->
      ...
      <![endif]-->
            ...
            <div class="head" style="background: url(<?= IMG_URL ?>bg-head.jpg) top center / cover repeat; margin: 0px auto; max-width: 680px;">
                <div style="line-height: 0; font-size: 0;">
                    <table align="center" background="<?= IMG_URL ?>bg-head.jpg" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background: url(<?= IMG_URL ?>bg-head.jpg) top center / cover repeat; width: 100%;">
                        <tbody>
                            <tr>
        ...
        <tr>
          ...
          <![endif]-->
                                    ...
                                    <div class="mj-column-px-80 outlook-group-fix mob" style="font-size: 13px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                            <tbody>
                                                <tr>
          ...
          <![endif]-->
                                    ...
                                    <div class="mj-column-px-110 outlook-group-fix logo" style="font-size: 13px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="vertical-align: top; padding: 0;">
          ...
          <![endif]-->
                                    ...
                                    <div class="mj-column-px-375 outlook-group-fix titre1" style="font-size: 13px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="vertical-align: top; padding: 0;">
                                                            ...
                                                            <tr>
                                                                <td align="left" class="titre" style="font-size: 0px; padding: 15px 0 29px 20px; word-break: break-word;">
                                                                    <div style="font-family: Arial; font-size: 24px; font-weight: 700; line-height: 30px; text-align: left; color: #ffffff;">
                                                                       <?php echo __("Vous êtes <br>invités !","kotikota_mail") ?>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
          ...
          <![endif]-->
                                    ...
                                    <div class="mj-column-px-114 outlook-group-fix mob" style="font-size: 13px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="vertical-align: top; padding: 0;">
      ...
      <![endif]-->
            ...
            <div class="content" style="background: #f3f3f3; background-color: #f3f3f3; margin: 0px auto; max-width: 680px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="background-color: #ffffff; vertical-align: top; padding: 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                                        <tr>
                                                            <td align="center" style="font-size: 0px; padding: 40px 0 30px; word-break: break-word;">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; border-spacing: 0px;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width: 60px;">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text" style="font-size: 0px; padding: 0 46px 10px; word-break: break-word;">
                                                                <div style="font-family: Arial; font-size: 16px; line-height: 24px; text-align: center; color: #000000;">
                                                                    <?php echo __("Bonjour, Salama, Hello,","kotikota_mail") ?><br>
                                                                    <?php echo __("Je vous invite à participer à la cagnotte:","kotikota_mail") ?><br>
                                                                    <strong><?= $nomcagnotte ?></strong>
                                                                    <br>
                                                                    <br>
                                                                    <?php echo __("Organisée par:","kotikota_mail") ?> <?= $prenom ?> <?= $nom ?>
                                                                    <br>
                                                                    <br>
                                                                    <?php echo __("Pour participer, c'est simple, rapide et sécurisé.<br>
                                                                    Inutile de vous inscrire.<br>
                                                                    Seul un clic suffit<br>","kotikota_mail") ?>

                                                                    <a href="<?= get_permalink( $idCagnotte ) ?>?origin=invite"><?php echo __("PARTICIPER","kotikota_mail"); ?></a>
      ...
      <![endif]-->
            ...
            <div style="background: #f3f3f3; background-color: #f3f3f3; margin: 0px auto; max-width: 680px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background: #f3f3f3; background-color: #f3f3f3; width: 100%;">
                    <tbody>
                        <tr>
                            <td style="direction: ltr; font-size: 0px; padding: 0; text-align: center; vertical-align: top;">
          ...
          <![endif]-->
                                ...
                                <div class="mj-column-per-100 outlook-group-fix" style="font-size: 13px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                        <tbody>
                                            <tr>
                                                <td style="vertical-align: top; padding: 0; padding-bottom: 40px;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                                        <tr>
                                                            <td align="center" style="font-size: 0px; padding: 0; word-break: break-word;">
