                                                        ...
                                                        <tr>
                                                            <td align="center" class="text" style="font-size: 0px; padding: 0 46px 10px; word-break: break-word;">
                                                                <div style="font-family: Arial; font-size: 16px; line-height: 24px; text-align: center; color: #000000;">
                                                                    <p>Cher KotiKoteur 📢</p>
                                                                    <p>Votre cagnotte « <?= get_field('nom_de_la_cagnotte', $idCagnotte) ?> » a bien été clôturée ⌛👍.</p>
                                                                    <p>Vous retrouverez toutes la caractéristiques de la cagnotte en <a href="<?= get_permalink($idCagnotte) ?>">cliquant ici 🖱</a></p>
                                                                    <?php $devise = get_field('devise', $idCagnotte ); ?>
                                                                    <p>Montant à transférer : <?= get_field('montant_recolte', $idCagnotte).' MGA' ?></p>
                                                                    <p>Afin de pouvoir vous transférer les sommes 💰 par virement bancaire 💸<br> 
                                                                    Merci de nous confirmer par retour de mail 📩 les informations suivantes concernant l’heureux bénéficiaire de la cagnotte 👤<br>
                                                                    - Nom et prénom<br>
                                                                    - Téléphone<br>
                                                                    - Email<br>
                                                                    - RIB <br>
