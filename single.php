      ...
      <div class="det-cagnotte wow fadeIn" data-wow-delay="850ms">
          ...
          <div class="btn wow fadeIn" data-wow-delay="850ms">
              ...
              <?php if ( (is_user_logged_in() && get_field('titulaire_de_la_cagnotte')  == get_current_user_id()) || current_user_can('administrator') ): ?>
                ...
                <a href="<?php echo get_permalink(get_page_by_path( 'gestion-cagnotte-invite')) ?>" id="gestionner" data-id="<?php echo $post->ID ?>" data-url="<?php echo get_permalink(get_page_by_path( 'gestion-cagnotte-invite')) ?>" class="link" title="<?php _e('Gestion des Participations','kotikota'); ?>"><?php _e('Gestion des Participations','kotikota'); ?></a>
