        ...
        <div class="item <?php if ($couleur) echo ' '.$couleur ?>">
            <div class="content">
                <a href="<?php the_permalink(); ?>" class="img">
                    ...
                    <?php 
                            ...
                            <span class="ico-percent">
                                <div class="percent" style="width:35px;height:35px;">
                ...
                <div class="compteur">
                    ...
                    <div class="amount">
                        <span><?php 
                            if ( $type_cagnotte == 'solidaire' || get_field('titulaire_de_la_cagnotte')  == get_current_user_id() || current_user_can('administrator')){
