...
function custom_js_to_head() {
    ...
    <script>
    jQuery(function(){
        jQuery("body.post-type-cagnotte .wrap a.page-title-action").after('<a href="#" class="page-title-action rib-action">RIB Pdf</a>');
    });
    </script>
    <?php
}
...
function rib_pdf_admin_enqueue_scripts() {
    wp_enqueue_script( 'rib-pdf-input-js', get_stylesheet_directory_uri() . '/js/admin-script.js', false, '1.0.0' );
